// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IMuxerMplex.cs" company="JT-Soft (https://github.com/UniqProject/VideoConvert)">
...
namespace VideoConvert.AppServices.Muxer.Interfaces
{
    ...
    /// <summary>
    /// IMuxerMplex interface
    /// </summary>
    public interface IMuxerMplex
    {
        /// <summary>
        /// Execute a mplex demux process.
