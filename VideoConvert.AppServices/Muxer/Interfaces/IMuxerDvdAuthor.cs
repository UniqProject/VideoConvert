// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IMuxerDvdAuthor.cs" company="JT-Soft (https://github.com/UniqProject/VideoConvert)">
...
namespace VideoConvert.AppServices.Muxer.Interfaces
{
    ...
    /// <summary>
    /// IMuxerDvdAuthor interface
    /// </summary>
    public interface IMuxerDvdAuthor
    {
        /// <summary>
        /// Execute a dvdauthor demux process.
