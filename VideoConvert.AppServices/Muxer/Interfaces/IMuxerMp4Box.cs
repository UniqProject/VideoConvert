// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IMuxerMp4Box.cs" company="JT-Soft (https://github.com/UniqProject/VideoConvert)">
...
namespace VideoConvert.AppServices.Muxer.Interfaces
{
    ...
    /// <summary>
    /// IMuxerMp4Box interface
    /// </summary>
    public interface IMuxerMp4Box
    {
        /// <summary>
        /// Execute a mp4box demux process.
