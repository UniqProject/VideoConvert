...
namespace VideoConvert.Core.Encoder
{
    class NeroAACEnc
    {
        ...
        private readonly string _encProgressFmt = Processing.GetResourceString("oggenc_encoding_audio_progress");
        ...
        public void DoEncode(object sender, DoWorkEventArgs e)
        {
                           ...
                           decoder = BePipe.GenerateProcess(inputFile))
            {
                ...
                decoder.ErrorDataReceived += OnDecoderDataReceived;
                encoder.ErrorDataReceived += OnEncoderDataReceived;
        ...
        private void OnEncoderDataReceived(object outputSender, DataReceivedEventArgs outputEvent)
        {
        ...
        private void OnDecoderDataReceived(object o, DataReceivedEventArgs args)
        {
