========================================================================
    KONSOLENANWENDUNG: AVSInfo-Projektübersicht
========================================================================

Diese AVSInfo-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre AVSInfo-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "AVSInfo.pch und eine 
